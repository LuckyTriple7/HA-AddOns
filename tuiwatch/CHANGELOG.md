...
- ✅ 15 Tests: Mailserver-Prüfung (erfolgreich, Verbindungsfehler, abgelehnte Anmeldung, SSL-Betriebsart und dass nie eine Mail rausgeht), Adressbuch-Prüfung (PROPFIND statt Voll-Abzug, HTTP-Fehler, Zeitüberschreitung), keine Zeilen bei nicht eingerichteten Diensten, HA-Sensor bleibt bei totem Mailserver „on", Flugplan-Fehler verschluckt die Dienste-Prüfung nicht, IPv4-Umschaltung.
