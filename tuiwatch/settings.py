...
FIELDS: dict = {
    ...
    "notify_flight_changes": ("bool", True, None, "notify",
        "Flugzeiten-Wächter (Meine Reisen)",
        "Gleicht die Flüge gebuchter Reisen 1×/Tag mit dem Flugplan des Heimatflughafens ab (STR, FRA, MUC, FKB) und meldet eine geänderte Abflug-/Ankunftszeit oder einen Flug, der nicht mehr im Plan steht. Quelle ist der Flughafen, nicht TUI. Standard an."),
    ...
    "anthropic_model": ("choice", "claude-opus-5", ("claude-opus-5", "claude-opus-5-5", "claude-sonnet-5", "claude-haiku-4-5", "claude-fable-5-1"), "ai",
        "Claude-Modell fürs KI-Fazit",
        "Welches Claude-Modell für die Hotel-Zusammenfassung genutzt wird. Opus 5 = Standard, sehr gründlich. Opus 5.5 = Nachfolger von Opus 5, etwas günstiger. Sonnet = schneller/günstiger bei kaum schlechterer Qualität. Haiku = am günstigsten, kürzer. Fable 5.1 = leistungsfähigstes Modell, teuerster Aufruf (eine bestehende Fable-5-Auswahl läuft automatisch auf 5.1)."),
    ...
    "gemini_model": ("choice", "gemini-3.1-pro", ("gemini-3.1-pro", "gemini-3.8-flash", "gemini-3.7-flash", "gemini-3.6-flash"), "ai",
        "Gemini-Modell",
        "Welches Gemini-Modell genutzt wird, wenn 'KI-Anbieter' = gemini. 3.1 Pro = Flaggschiff, sehr gründlich. 3.8 Flash = neuestes und stärkstes Flash-Modell. 3.7 und 3.6 Flash = Vorgänger zum gleichen Preis. Eine bestehende Auswahl von 3.5 Flash oder 2.5 Flash läuft automatisch auf 3.8 Flash."),
