...
FIELDS: dict = {
    ...
    "perplexity_api_key": ("str", "", 400, "ai",
        "Perplexity API-Key",
        "API-Key für Perplexity (perplexity.ai/settings/api), nur relevant wenn 'KI-Anbieter' = perplexity. Angesprochen wird die Agent API; TUIWatch schaltet die Websuche je Aufgabe zu (Recherche ja, interne Aufgaben wie Auto-Tags nein), ein Websuche-Schalter ist nicht nötig. Recherche-Aufrufe sind teurer als bei Claude/Gemini, inkl. zusätzlicher Request-Gebühr oben auf die Tokenkosten. Leer lassen = Funktion aus."),
    "perplexity_model": ("choice", "sonar-pro", ("sonar", "sonar-pro", "sonar-reasoning-pro", "sonar-deep-research"), "ai",
        "Perplexity-Modell",
        "Welches Perplexity-Modell genutzt wird, wenn 'KI-Anbieter' = perplexity. sonar = günstigstes Basismodell. sonar-pro = Standard, gründlicher bei komplexeren Fragen. sonar-reasoning-pro = mit Zwischenschritten für schwierigere Abwägungen. sonar-deep-research = ausführlichste, teuerste Recherche. Perplexity unterstützt diese Sonar-Modelle weiter, auch nachdem die alte Sonar-API am 27.09.2026 ausläuft."),
