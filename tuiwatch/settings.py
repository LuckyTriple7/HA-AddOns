...
FIELDS: dict = {
    ...
    "perplexity_api_key": ("str", "", 400, "ai",
        "Perplexity API-Key",
        "API-Key für Perplexity (perplexity.ai/settings/api), nur relevant wenn 'KI-Anbieter' = perplexity. Sonar-Modelle durchsuchen bei JEDER Anfrage automatisch das Web (kein Websuche-Schalter nötig) — dafür pro Anfrage teurer als Claude/Gemini, inkl. zusätzlicher Request-Gebühr oben auf die Tokenkosten. Leer lassen = Funktion aus."),
    "perplexity_model": ("choice", "sonar-pro", ("sonar", "sonar-pro", "sonar-reasoning-pro", "sonar-deep-research"), "ai",
        "Perplexity-Modell",
        "Welches Perplexity-Modell genutzt wird, wenn 'KI-Anbieter' = perplexity. sonar = günstigstes Basismodell. sonar-pro = Standard, gründlicher bei komplexeren Fragen. sonar-reasoning-pro = mit Zwischenschritten für schwierigere Abwägungen. sonar-deep-research = ausführlichste, teuerste Recherche."),
