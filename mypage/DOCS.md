...
- **Startseite**: Die Bibliothek ist ein eigener Abschnitt — bis zu 12 Einträge als **seitwärts scrollendes Karussell** (wie die Fotoalben, mit Pfeilen und Touch-Wischen), darüber führt „Alle anzeigen →" auf die vollständige Übersicht. Der Abschnitt lässt sich im Tab *Inhalt* wie jeder andere sortieren, ausblenden oder auf Mitglieder beschränken.
