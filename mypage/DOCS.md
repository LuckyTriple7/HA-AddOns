...
- **Nicht gefunden (404)** — eine Liste der Aufrufe, die ins Leere liefen, **nach Adresse gebündelt** (nicht Zeile für Zeile: der erste Scanner würde die Ablage sonst mit `/wp-login.php` füllen). Je Adresse Anzahl, Zeitpunkt des letzten Versuchs, Verweisgeber und zwei Marken.
