...
- **Alternativtexte der Bilder**: Ein Bild ohne Alternativtext ist für Screenreader nicht vorhanden und für Suchmaschinen stumm. Unter dem Datei-Browser steht je Bild ein Feld für **Deutsch und Englisch**; standardmäßig sind nur die Bilder **ohne** Text eingeblendet. Der Text hängt an der **Datei**, nicht am Beitrag — dasselbe Bild zeigt überall dasselbe.
  ...
  - **Mit Gemini erzeugen:** Mit hinterlegtem Textmodell steht je Bild ein **„✦ KI"**-Knopf bereit, dazu **„Alle fehlenden erzeugen"** (der Reihe nach, wegen des Stundenlimits). Der Vorschlag landet erst im Feld — **gespeichert wird mit „Speichern"**, damit er sich vorher korrigieren lässt. Jede Anfrage zählt auf das Textkontingent.
